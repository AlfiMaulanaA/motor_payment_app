...
@section('content')
    <div class="container">
        <h1 class="my-4 text-center">Tambah Paket Kredit</h1>
        <form action="{{ route('kredit-paket.store') }}" method="POST">
            @csrf
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" id="paket_harga_cash" name="paket_harga_cash" required>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label for="paket_uang_muka" class="form-label">Uang Muka</label>
                    <input type="number" class="form-control" id="paket_uang_muka" name="paket_uang_muka" required>
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" class="form-control" id="paket_bunga" name="paket_bunga" step="0.01" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="paket_nilai_cicilan" class="form-label">Nilai Cicilan</label>
                    <input type="number" class="form-control" id="paket_nilai_cicilan" name="paket_nilai_cicilan" required>
                </div>
            </div>
